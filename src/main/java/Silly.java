...
public class Silly implements Comparable<Silly>{
    ...
    public Silly(String firstStr, String secondStr){
        this.name = firstStr + secondStr;
    }

    /**
     * Creates a new Silly Object.
     * Takes two String as arguments
     * @param firstStr the first string in the concatenation
     * @param secondStr the second string in the concatenation
     */
